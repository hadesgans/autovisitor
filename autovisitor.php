...
echo "$cyan COPYRIGHT © SW1337, ROBH HACKER TEAM ALL RIGHT RESERVED\n";

echo "$cyan ___           _     _

  
  ___________      __   ____________ _________________ 
 /   _____/  \    /  \ /_   \_____  \\_____  \______  \
 \_____  \\   \/\/   /  |   | _(__  <  _(__  <   /    /
 /        \\        /   |   |/       \/       \ /    / 
/_______  / \__/\  /    |___/______  /______  //____/  
        \/       \/                \/       \/         
\n";
echo "_   _                 _
COPYRIGHT © ROBH HACKER TEAM ALL RIGHT RESERVED\n\n";

echo " ONLY GOD CAN STOP ME! :) \n ";
echo " $merah INFO! ";
echo file_get_contents("https://pastebin.com/raw/k4qabq9K");
echo " \n";
echo "$hijau Instagram : @hades.dewa\n";
echo " Facebook : http://fb.me/riska.yuani \n";
echo " Email : hades.hax0r@yandex.com \n";
echo " \n \n";
echo " ------------- AUTO VISITOR BLOG 2020 -------------\n  ";
echo ' MASUKIN BLOGGER LU COK! : ';
